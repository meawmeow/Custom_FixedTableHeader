...
import th.co.businessplus.kotlinui1.custom_table.lib_qtable.QTableFixSize;
...
public class LibQTableFixSizeJavaActivity extends AppCompatActivity implements HorizontalScroll.ScrollViewListener  {
    ...
    QTableFixSize headerQTable;
    QTableFixSize footersQTable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lib_q2_table_java);
        getSupportActionBar().setTitle("QTableFixSize java");
        ...
        dataHeaderList = new String[]{"Colum1", "Colum2", "Colum3"};
        widthColumList = new Integer[]{100, 100};
        ...
        //init Qtable Header
        headerQTable = new QTableFixSize(this, relativeLayoutHeader_id);
        headerQTable.initHeaderLayoutMain(0,18,50,3,true);
        ...
        //init Qtable Footer
        footersQTable = new QTableFixSize(this, relativeLayoutFooter_id);
        footersQTable.initHeaderLayoutMain(0,18,50,3,false);
            ...
            for (int c = 1; c < dataHeaderTable.get(i).data.length; c++) {
                if (i % 2 == 0) {
                    headerQTable.AddDataBodyTable(
                            i,
                            "uu:"+dataHeaderTable.get(i).data[c],
                            16f,
                            widthColumList[c-1],
                    ...
                    headerQTable.AddDataBodyTable(
                            i,
                            "kk:"+dataHeaderTable.get(i).data[c],
                            16f,
                            widthColumList[c-1],
                            textAlignmentBodyList[c],
                            getResources().getColor(R.color.ColorBodyColum),
