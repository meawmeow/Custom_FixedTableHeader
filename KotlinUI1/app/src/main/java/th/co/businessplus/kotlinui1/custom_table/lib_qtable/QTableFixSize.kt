...
class QTableFixSize : HorizontalScroll.ScrollViewListener,
    ...
    //new value
    var widthFirstCol = 0;
    var widthColumRelativeLayout = 0
    var widthHorizontalScroll = 0
    var maxWidthPadingSize = 100
    var PadingFirstColumWidth = -20//65
    ...
    constructor(context: Context, relativeLayoutHeader: RelativeLayout) {
     ...
     fun initHeaderLayoutMain(_RowHeaderHeight :Int,_RowHeight :Int,_PadingFirstColumWidth : Int,_ColumWidthSize :Int,visibleHeader: Boolean = true) {
         this.RowHeaderHeight = _RowHeaderHeight
         this.RowHeight = _RowHeight;
         this.PadingFirstColumWidth = _PadingFirstColumWidth
...
//    var ColumWidthSize = 5
    ...
    private fun initializeRelativeLayoutHeaderMain(visibleHeader: Boolean = true) {
        ...
        //FirstColumWidthSize = 4
        widthFirstCol = (SCREEN_WIDTH / ColumWidthSize) - PadingFirstColumWidth;//new 04/09/2020
        //Main layout Header Data
        relativeLayoutHeaderColumFirstFix.layoutParams =
            RelativeLayout.LayoutParams(widthFirstCol, (SCREEN_HEIGHT / RowHeight)+RowHeaderHeight)
        ...
        widthColumRelativeLayout = ((SCREEN_WIDTH + widthFirstCol) - (SCREEN_WIDTH / ColumWidthSize));//new 04/09/2020

        val layoutParamsRelativeHeaderColumScroll =
            RelativeLayout.LayoutParams(
                widthColumRelativeLayout,
    ...
    private fun initializeScrollersLayoutHeaderMain() {
        ...
        widthHorizontalScroll = (SCREEN_WIDTH + ((widthFirstCol) / ColumWidthSize));//new 04/09/2020

        horizontalScrollViewHeaderData.layoutParams =
            ViewGroup.LayoutParams(widthHorizontalScroll, (SCREEN_HEIGHT / RowHeight)+RowHeaderHeight)

        verticalScrollViewBodyDataFirst.layoutParams =
            ViewGroup.LayoutParams(widthFirstCol, SCREEN_HEIGHT - (SCREEN_HEIGHT / RowHeight))

        verticalScrollViewBodyData.layoutParams =
            ViewGroup.LayoutParams(
                widthHorizontalScroll,
                SCREEN_HEIGHT - (SCREEN_HEIGHT / RowHeight)
            )
    ...
    private fun initializeTableLayoutHeaderMain() {
        ...
        val layoutParamsTableLayoutHeaderColumFirstFix =
            TableLayout.LayoutParams(widthFirstCol, (SCREEN_HEIGHT / RowHeight)+RowHeaderHeight)
        ...
        val layoutParamsTableLayoutHeaderColumScroll =
            TableLayout.LayoutParams(widthHorizontalScroll, (SCREEN_HEIGHT / RowHeight)+RowHeaderHeight)
        ...
        val layoutParamsTableLayoutBodyDataColumFirst =
            TableLayout.LayoutParams(SCREEN_WIDTH / 2, SCREEN_HEIGHT - (SCREEN_HEIGHT / RowHeight))
    ...
    private fun addRowToTableHeaderColumFirstFix(
        ...
        tableRowAFix.layoutParams =
            TableRow.LayoutParams(widthFirstCol, (SCREEN_HEIGHT / RowHeight)+RowHeaderHeight)
        Log.d("DSSH","widthFirstCol:"+widthFirstCol);
...
//        tableRowAFix.layoutParams =
//            TableRow.LayoutParams((((SCREEN_WIDTH - widthFirstCol) / (ColumWidthSize - 1)) - maxWidthPadingSize) + width, SCREEN_HEIGHT / RowHeaderHeight)
        tableRowAFix.layoutParams =
            TableRow.LayoutParams((((SCREEN_WIDTH - widthFirstCol) / (ColumWidthSize - 1)) - maxWidthPadingSize) + width, (SCREEN_HEIGHT / RowHeight)+RowHeaderHeight)
    ...
    private fun addRowToTableAtFirst(
        ...
        tableRowData.layoutParams =
            TableRow.LayoutParams(widthFirstCol, SCREEN_HEIGHT / RowHeight)
    ...
    private fun addColumnToTableAtScroll(
        ...
        tableRowAFix.layoutParams =
            TableRow.LayoutParams((((SCREEN_WIDTH - widthFirstCol) / (ColumWidthSize - 1)) - maxWidthPadingSize) + width, (SCREEN_HEIGHT / RowHeight))
