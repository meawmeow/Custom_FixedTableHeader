...
class QPaginationMutableList<T> {
    ...
    lateinit var dataList: MutableList<out T>
    ...
    fun initPagination(PAGE_DATA_SIZE: Int = 15, PAGE_BTN_SIZE: Int = 5) {
    ...
    fun setPageDataList(dataList: MutableList<out T>) {
    ...
    fun getListForPage(): MutableList<out T> {
